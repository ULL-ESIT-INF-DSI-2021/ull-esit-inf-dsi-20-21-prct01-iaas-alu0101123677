...
Conectados a la VPN accedemos a ----- con nuestro correo institucional, elegimos la máquina virtual de DSI y la iniciamos, una vez que la iniciamos se nos asignara una para nuestro uso, la mía en concreto es la -----. Dentro del menú de la máquina buscamos la IP externa para así poder acceder remotamente.
